package cn.itcast.core.controller.alipay;
...
//        main.test_trade_refund();
        ...
        // 测试当面付2.0生成支付二维码
       String path=main.test_trade_precreate();
       model.addAttribute("path",path);
       model.addAttribute("weixin","weixin://wxpay/bizpayurl?pr=cpwrUYX");
       model.addAttribute("amt","0.01");
       model.addAttribute("order","10010");
       model.addAttribute("orderID","10086");
       // main.test_trade_pay(tradeWithHBService);
       return "tstPage";
        //测试获得应用授权令牌
...
//        extendInfo.put("TERMINAL_ID", "1234");
        ...
        String appAuthToken = "201510BBaabdb44d8fd04607abf8d5931ec75D84";//根据真实值填写
...
//                .setExceptionInfoList(exceptionInfoList) // 填写异常信息，如果有的话
    ...
    public void test_trade_pay(AlipayTradeService service) {
       ...
       // String authCode = "用户自己的支付宝付款码"; // 条码示例，286648048691290423
        String authCode = "285731335346079730";
