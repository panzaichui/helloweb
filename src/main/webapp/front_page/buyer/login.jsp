...
<div class="w loc">
	<div class="h-title" id="logo">
		<div class="h-logo l"><img src="/hello2/res/img/pic/logo-1.png"/></div>
		<div class="l" style="margin: 13px 10px;font-size: 20px;font-family: '微软雅黑';letter-spacing: 2px">欢迎登录</div>
	</div>
</div>
<div class="sign">
	<div class="l ad420x205"><a href="#" title="title"><img src="/hello2/res/img/pic/ppp0.jpg" width="400" height="400"/></a></div>
	<div class="r">
