...
<script src="/hello2/res/js/jquery.js"></script>
<script src="/hello2/res/js/com.js"></script>
</head>
<body>
...
<div class="w loc">
	<div class="h-title">
		<div class="h-logo"><a href="http://localhost:8080"><img src="/hello2/res/img/pic/logo-1.png" /></a></div>
	    <div class="h-search">
	      	<input type="text" />
		...
		<dd class="hidden">
			...
			<ul class="uls">
				<li>
					...
					<img src="/hello2/res/img/pic/p50x50.jpg" alt="依琦莲2014瑜伽服套装新 瑜珈健身服三件套 广场舞蹈服装 女瑜伽服送胸垫 长袖紫色 M全场支持货到付款 全网最低价 千人超高好评瑜伽服赶紧抢！全五分好评截图联系客服还返现五元" /></a>
